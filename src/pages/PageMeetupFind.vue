  ...
  <div>
          ...
          <div class="level">
            <div class="level-left">
              ...
              <div v-if="category" class="level-item">
                <button @click="cancelCategory" class="button is-danger is-rounded">{{ category }} X</button>
              </div>
            </div>
    ...
    <div v-if="pageLoader_isDataLoaded" class="container">
      <section class="section page-find">
        ...
        <div v-else>
          <span
            class="tag is-primary is-large is-rounded"
...
export default {
  ...
  computed: {
    meetups() {
      const meetups = this.$store.state.meetups.items;
      return _.orderBy(meetups, "startDate");
    }
  },
  methods: {
    fetchMeetups () {
